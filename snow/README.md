...
A node in the Avalanche network can either be a validator or a non-validator. A validator stakes DJTX tokens and participates in consensus to earn rewards. A non-validator does not participate in consensus or have any DJTX staked but is used as a public API. Both validators and non-validator need to have their own copy of the chain and to know the current state of the mempool. At the time of writing, there are ~1200 validators and ~1800 non-validator.
...
### [Outbound Messages](https://github.com/lasthyphen/dijetsnodesgo/blob/master/message/outbound_msg_builder.go)
...
### [Network](https://github.com/lasthyphen/dijetsnodesgo/blob/master/network/network.go)
...
## [Router](https://github.com/lasthyphen/dijetsnodesgo/blob/master/snow/networking/router/chain_router.go)
...
## [Handler](https://github.com/lasthyphen/dijetsnodesgo/blob/master/snow/networking/handler/handler.go)
...
## [Sender](https://github.com/lasthyphen/dijetsnodesgo/blob/master/snow/networking/sender/sender.go)
...
## [Consensus Engine](https://github.com/lasthyphen/dijetsnodesgo/blob/master/snow/consensus/snowman/consensus.go)
...
## [Blockchain Creation](https://github.com/lasthyphen/dijetsnodesgo/blob/master/chains/manager.go)
