...
// Source: github.com/lasthyphen/dijetsnodesgo/snow/engine/dijets (interfaces: Engine)

// Package dijets is a generated GoMock package.
package dijets
...
func (m *MockEngine) GetVtx(arg0 context.Context, arg1 ids.ID) (dijets.Vertex, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetVtx", arg0, arg1)
	ret0, _ := ret[0].(dijets.Vertex)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockEngineMockRecorder) GetVtx(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetVtx", reflect.TypeOf((*MockEngine)(nil).GetVtx), arg0, arg1)
}
