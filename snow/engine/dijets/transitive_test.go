...
import (
	...
	"github.com/lasthyphen/dijetsnodesgo/snow/consensus/snowstorm"
...
func TestEngineAdd(t *testing.T) {
	...
	manager.ParseVtxF = func(_ context.Context, b []byte) (dijets.Vertex, error) {
	...
	manager.ParseVtxF = func(context.Context, []byte) (dijets.Vertex, error) {
...
func TestEngineQuery(t *testing.T) {
	...
	manager.GetVtxF = func(_ context.Context, id ids.ID) (dijets.Vertex, error) {
		switch id {
		case gVtx.ID():
			return gVtx, nil
		case mVtx.ID():
	...
	vertexed := new(bool)
	manager.GetVtxF = func(_ context.Context, vtxID ids.ID) (dijets.Vertex, error) {
		if *vertexed {
...
func TestEngineMultipleQuery(t *testing.T) {
	...
	engCfg.Params = dijets.Parameters{
...
func TestEngineAbandonResponse(t *testing.T) {
	...
	manager.GetVtxF = func(context.Context, ids.ID) (dijets.Vertex, error) {
		return nil, errUnknownVertex
	}
...
func TestEngineRejectDoubleSpendTx(t *testing.T) {
	...
	manager.BuildVtxF = func(_ context.Context, _ []ids.ID, txs []snowstorm.Tx) (dijets.Vertex, error) {
		return &dijets.TestVertex{
			TestDecidable: choices.TestDecidable{
				IDV:     ids.GenerateTestID(),
				StatusV: choices.Processing,
...
func TestEngineDuplicatedIssuance(t *testing.T) {
	...
	manager.BuildVtxF = func(context.Context, []ids.ID, []snowstorm.Tx) (dijets.Vertex, error) {
