...
type Builder interface {
	...
	BuildVtx(ctx context.Context, parentIDs []ids.ID, txs []snowstorm.Tx) (dijets.Vertex, error)
	// Build a new stop vertex from the parents
	BuildStopVtx(ctx context.Context, parentIDs []ids.ID) (dijets.Vertex, error)
}
