...
func (b *bootstrapper) process(ctx context.Context, vtxs ...dijets.Vertex) error {
...
func (b *bootstrapper) checkFinish(ctx context.Context) error {
	...
	if !b.Config.Subnet.IsBootstrapped() {
		if !b.Config.SharedCfg.Restarted {
			b.Ctx.Log.Info("waiting for Dijets Ternary Chain Ledgers to finish syncing with Chief Network")
		} else {
			b.Ctx.Log.Debug("waiting for Dijets Ternary Chain Ledgers to finish syncing with Chief Network")
		}
