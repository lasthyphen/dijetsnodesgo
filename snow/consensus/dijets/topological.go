...
import (
	...
	"github.com/lasthyphen/dijetsnodesgo/snow/consensus/metrics"
...
func (ta *Topological) HealthCheck(ctx context.Context) (interface{}, error) {
	...
	if !healthy {
		...
		return details, fmt.Errorf("dijets consensus is not healthy reason: %s", strings.Join(errorReasons, ", "))
	}
	return details, nil
}
