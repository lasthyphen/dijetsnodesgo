...
import (
	...
	xchaintxs "github.com/lasthyphen/dijetsnodesgo/vms/avm/txs"
	pchaintxs "github.com/lasthyphen/dijetsnodesgo/vms/platformvm/txs"
)

const (
	defaultEncoding    = formatting.Hex
	configChainIDAlias = "V"
)
...
func FromConfig(config *Config) ([]byte, ids.ID, error) {
	...
	}
	{
		...
		avmArgs.GenesisData = map[string]avm.AssetDefinition{
			"DJT": djtx, // The AVM starts out with one asset: DJTX
		}
	}
