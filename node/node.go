...
import (
	...
	"github.com/lasthyphen/dijetsnodesgo/api/admin"
	"github.com/lasthyphen/dijetsnodesgo/api/auth"
	...
	"github.com/lasthyphen/dijetsnodesgo/chains"
	...
	"github.com/lasthyphen/dijetsnodesgo/ipcs"
	"github.com/lasthyphen/dijetsnodesgo/message"
	"github.com/lasthyphen/dijetsnodesgo/network"
	"github.com/lasthyphen/dijetsnodesgo/network/dialer"
	"github.com/lasthyphen/dijetsnodesgo/network/peer"
	...
	"github.com/lasthyphen/dijetsnodesgo/utils/filesystem"
	...
	"github.com/lasthyphen/dijetsnodesgo/utils/math/meter"
	"github.com/lasthyphen/dijetsnodesgo/utils/perms"
	"github.com/lasthyphen/dijetsnodesgo/utils/profiler"
	"github.com/lasthyphen/dijetsnodesgo/utils/resource"
	...
	"github.com/lasthyphen/dijetsnodesgo/vms/registry"
	"github.com/lasthyphen/dijetsnodesgo/vms/secp256k1fx"

	ipcsapi "github.com/lasthyphen/dijetsnodesgo/api/ipcs"
)
...
func (n *Node) initNetworking(primaryNetVdrs validators.Set) error {
	...
	if err != nil {
		n.Log.Info("initialising Dijets networking protocol",
...
func (n *Node) Dispatch() error {
	...
	go n.Log.RecoverAndPanic(func() {
		...
		if n.Config.HTTPSEnabled {
			n.Log.Debug("initialising Dijets API server with TLS")
			err = n.APIServer.DispatchTLS(n.Config.HTTPSCert, n.Config.HTTPSKey)
		} else {
			n.Log.Debug("initialising Dijets API server without TLS")
...
func (n *Node) initDatabase() error {
	...
	n.Log.Info("initialising Dijets network databases",
...
func (n *Node) initChains(genesisBytes []byte) {
	n.Log.Info("initialising Dijets Ternary Chain Ledgers")
...
func (n *Node) initAPIServer() error {
	n.Log.Info("initialising Dijets API server")
...
func (n *Node) initVMs() error {
	n.Log.Info("initialising Dijets Virtual machine Engines")
...
func (n *Node) initSharedMemory() {
	n.Log.Info("initialising Dijets SharedMemory")
...
func (n *Node) initKeystoreAPI() error {
	n.Log.Info("initialising Dijets Node Keystore")
	...
	n.Log.Info("initialising Dijets keystore API")
	handler := &common.HTTPHandler{
		LockOptions: common.NoLock,
...
func (n *Node) initMetricsAPI() error {
	...
	n.Log.Info("initialising Dijets metrics API")
...
func (n *Node) initAdminAPI() error {
	...
	n.Log.Info("initialising Dijets admin API")
...
func (n *Node) initProfiler() {
	...
	n.Log.Info("initialising continuous profiler")
...
func (n *Node) initInfoAPI() error {
	...
	n.Log.Info("initialising Dijets Node info API")
...
func (n *Node) initHealthAPI() error {
	...
	n.Log.Info("initialising Dijets Node Health API")
...
func (n *Node) initIPCAPI() error {
	...
	n.Log.Info("initialising Dijets ipc API")
...
func (n *Node) initChainAliases(genesisBytes []byte) error {
	n.Log.Info("initialising Dijets Ternary Chain aliases")
...
func (n *Node) initAPIAliases(genesisBytes []byte) error {
	n.Log.Info("initialising Dijets Node API aliases")
...
func (n *Node) Initialize(
	...
	n.Log.Info("Initialising Dijets Network node",
...
func (n *Node) shutdown() {
	n.Log.Info("shutting down Dijets node",
	...
	n.Log.Info("finished Dijets node shutdown")
}
