...
import (
	...
	blockbuilder "github.com/lasthyphen/dijetsnodesgo/vms/platformvm/blocks/builder"
	blockexecutor "github.com/lasthyphen/dijetsnodesgo/vms/platformvm/blocks/executor"
	txbuilder "github.com/lasthyphen/dijetsnodesgo/vms/platformvm/txs/builder"
...
type VM struct {
	...
	atomicUtxosManager djtx.AtomicUTXOManager
...
func (vm *VM) Initialize(
	...
	chainCtx.Log.Verbo("initialising Method chain")
	...
	vm.atomicUtxosManager = djtx.NewAtomicUTXOManager(chainCtx.SharedMemory, txs.Codec)
...
func (vm *VM) CreateHandlers(context.Context) (map[string]*common.HTTPHandler, error) {
	...
	if err := server.RegisterService(
		&Service{
			vm:          vm,
			addrManager: djtx.NewAddressManager(vm.ctx),
		},
		"platform",
	); err != nil {
		return nil, err
