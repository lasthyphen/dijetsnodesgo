...
import (
	...
	"github.com/lasthyphen/dijetsnodesgo/snow/engine/snowman/bootstrap"
	...
	"github.com/lasthyphen/dijetsnodesgo/vms/platformvm/api"
	...
	blockexecutor "github.com/lasthyphen/dijetsnodesgo/vms/platformvm/blocks/executor"
	txexecutor "github.com/lasthyphen/dijetsnodesgo/vms/platformvm/txs/executor"
)
...
func TestRestartFullyAccepted(t *testing.T) {
	...
	tx := &txs.Tx{Unsigned: &txs.ImportTx{
		...
		ImportedInputs: []*djtx.TransferableInput{{
			...
			Asset: djtx.Asset{ID: firstVM.ctx.DJTXAssetID},
			In: &secp256k1fx.TransferInput{
				Amt: 50000,
			},
		}},
