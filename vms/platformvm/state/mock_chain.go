...
// Source: github.com/lasthyphen/dijetsnodesgo/vms/platformvm/state (interfaces: Chain)
...
func (m *MockChain) AddRewardUTXO(arg0 ids.ID, arg1 *djtx.UTXO) {
	m.ctrl.T.Helper()
...
func (m *MockChain) AddUTXO(arg0 *djtx.UTXO) {
	m.ctrl.T.Helper()
...
func (m *MockChain) GetRewardUTXOs(arg0 ids.ID) ([]*djtx.UTXO, error) {
	m.ctrl.T.Helper()
...
func (m *MockChain) GetUTXO(arg0 ids.ID) (*djtx.UTXO, error) {
	m.ctrl.T.Helper()
