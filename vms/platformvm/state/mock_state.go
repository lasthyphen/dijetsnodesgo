...
// Source: github.com/lasthyphen/dijetsnodesgo/vms/platformvm/state (interfaces: State)
...
import (
	...
	bls "github.com/lasthyphen/dijetsnodesgo/utils/crypto/bls"
...
func (m *MockState) AddRewardUTXO(arg0 ids.ID, arg1 *djtx.UTXO) {
	m.ctrl.T.Helper()
...
func (m *MockState) AddUTXO(arg0 *djtx.UTXO) {
	m.ctrl.T.Helper()
...
func (m *MockState) GetRewardUTXOs(arg0 ids.ID) ([]*djtx.UTXO, error) {
	m.ctrl.T.Helper()
...
func (m *MockState) GetUTXO(arg0 ids.ID) (*djtx.UTXO, error) {
	m.ctrl.T.Helper()
