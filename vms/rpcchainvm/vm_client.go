...
import (
	...
	"github.com/lasthyphen/dijetsnodesgo/api/keystore/gkeystore"
	"github.com/lasthyphen/dijetsnodesgo/api/metrics"
	"github.com/lasthyphen/dijetsnodesgo/chains/atomic/gsharedmemory"
	"github.com/lasthyphen/dijetsnodesgo/database/manager"
	"github.com/lasthyphen/dijetsnodesgo/database/rpcdb"
	"github.com/lasthyphen/dijetsnodesgo/ids"
	"github.com/lasthyphen/dijetsnodesgo/ids/galiasreader"
	...
	"github.com/lasthyphen/dijetsnodesgo/snow/engine/common/appsender"
	"github.com/lasthyphen/dijetsnodesgo/snow/engine/snowman/block"
	"github.com/lasthyphen/dijetsnodesgo/snow/validators/gvalidators"
	...
	"github.com/lasthyphen/dijetsnodesgo/vms/rpcchainvm/ghttp"
	"github.com/lasthyphen/dijetsnodesgo/vms/rpcchainvm/grpcutils"
	"github.com/lasthyphen/dijetsnodesgo/vms/rpcchainvm/gsubnetlookup"
	"github.com/lasthyphen/dijetsnodesgo/vms/rpcchainvm/messenger"

	aliasreaderpb "github.com/lasthyphen/dijetsnodesgo/proto/pb/aliasreader"
	appsenderpb "github.com/lasthyphen/dijetsnodesgo/proto/pb/appsender"
	httppb "github.com/lasthyphen/dijetsnodesgo/proto/pb/http"
	...
	subnetlookuppb "github.com/lasthyphen/dijetsnodesgo/proto/pb/subnetlookup"
	validatorstatepb "github.com/lasthyphen/dijetsnodesgo/proto/pb/validatorstate"
	vmpb "github.com/lasthyphen/dijetsnodesgo/proto/pb/vm"
)
...
func (vm *VMClient) Initialize(
	...
	resp, err := vm.client.Initialize(ctx, &vmpb.InitializeRequest{
		...
		DjtxAssetId:  chainCtx.DJTXAssetID[:],
