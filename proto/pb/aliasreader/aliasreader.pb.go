...
var file_aliasreader_aliasreader_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x69, 0x61, 0x73, 0x72, 0x65, 0x61, 0x64, 0x65, 0x72, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_aliasreader_aliasreader_proto_goTypes = []interface{}{
...
func file_aliasreader_aliasreader_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_aliasreader_aliasreader_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ID); i {
			case 0:
				return &v.state
			case 1:
		...
		file_aliasreader_aliasreader_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Alias); i {
			case 0:
				return &v.state
			case 1:
		...
		file_aliasreader_aliasreader_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
