...
import (
	...
	"github.com/lasthyphen/dijetsnodesgo/app/runner"
	...
	"github.com/lasthyphen/dijetsnodesgo/nat"
	...
	"github.com/lasthyphen/dijetsnodesgo/node"
	...
	"github.com/lasthyphen/dijetsnodesgo/staking"
	...
	"github.com/lasthyphen/dijetsnodesgo/utils/dynamicip"
	"github.com/lasthyphen/dijetsnodesgo/utils/ips"
	"github.com/lasthyphen/dijetsnodesgo/utils/logging"
	"github.com/lasthyphen/dijetsnodesgo/utils/password"
	...
	"github.com/lasthyphen/dijetsnodesgo/utils/storage"
...
func getStakingConfig(v *viper.Viper, networkID uint32) (node.StakingConfig, error) {
	...
	if !config.EnableStaking && (networkID == constants.MainnetID || networkID == constants.LotharID) {
	...
	if networkID != constants.MainnetID && networkID != constants.LotharID {
