...
import (
	...
	"github.com/lasthyphen/dijetsnodesgo/utils/crypto/keychain"
...
func (s *signer) getSigners(ctx stdcontext.Context, sourceChainID ids.ID, ins []*djtx.TransferableInput) ([]verify.Verifiable, [][]keychain.Signer, error) {
