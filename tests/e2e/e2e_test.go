...
import (
	...
	_ "github.com/lasthyphen/dijetsnodesgo/tests/e2e/banff"
	_ "github.com/lasthyphen/dijetsnodesgo/tests/e2e/p"
	_ "github.com/lasthyphen/dijetsnodesgo/tests/e2e/ping"
	_ "github.com/lasthyphen/dijetsnodesgo/tests/e2e/static-handlers"
	_ "github.com/lasthyphen/dijetsnodesgo/tests/e2e/x/transfer"
	_ "github.com/lasthyphen/dijetsnodesgo/tests/e2e/x/whitelist-vtx"
)
...
func init() {
	...
	flag.StringVar(
		...
		"uris",
		"",
		"HTTP RPC endpoint URIs for dijets node (comma-separated, required to run against existing cluster)",
	)
