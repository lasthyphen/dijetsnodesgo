...
# https://github.com/lasthyphen/dijetsnodesgo/releases
GOARCH=$(go env GOARCH)
GOOS=$(go env GOOS)
DOWNLOAD_URL=https://github.com/lasthyphen/dijetsnodesgo/releases/download/v${VERSION}/avalanchego-linux-${GOARCH}-v${VERSION}.tar.gz
DOWNLOAD_PATH=/tmp/avalanchego.tar.gz
if [[ ${GOOS} == "darwin" ]]; then
  DOWNLOAD_URL=https://github.com/lasthyphen/dijetsnodesgo/releases/download/v${VERSION}/avalanchego-macos-v${VERSION}.zip
