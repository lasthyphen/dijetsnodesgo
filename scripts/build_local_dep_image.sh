...
echo "Building docker image based off of most recent local commits of dijetsnodesgo and coreth"

AVALANCHE_REMOTE="git@github.com:lasthyphen/dijetsnodesgo.git"
CORETH_REMOTE="git@github.com:lasthyphen/coreth.git"
DOCKERHUB_REPO="hyphenesc/phase3"
...
AVALANCHE_CLONE="$WORKPREFIX/dijetsnodesgo"
...
AVALANCHE_COMMIT_HASH="$(git -C "$EXISTING_GOPATH/$AVA_LABS_RELATIVE_PATH/dijetsnodesgo" rev-parse --short HEAD)"
